...
(8888, 'SCOTT', 'ANALYST', 8566, '1992-09-12', 3000.00, NULL, 20),
(8839, 'AMIR', 'PRESIDENT', NULL, '1991-11-18', 5000.00, NULL, 10),
(8444, 'KULDEEP', 'SALESMAN', 8698, '1991-09-08', 1500.00, 0.00, 30);

SELECT * FROM Emp1;
SELECT ename, sal FROM Emp1 WHERE sal >= 2200;
SELECT * FROM Emp1 WHERE comm IS NULL OR comm = 0;
SELECT ename, sal FROM Emp1 WHERE sal < 2500 OR sal > 4000;
